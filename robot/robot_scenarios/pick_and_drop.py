...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world):
        ...
        for i, object in enumerate(world.objects):
            ...
            object.state.p_pos =  world.object_position(world.agents[0].state.p_pos, radius=2*world.arm_length)

        # set goal properties
        world.goals[0].state.p_pos = world.object_position(world.agents[0].state.p_pos, radius=2*world.arm_length)
